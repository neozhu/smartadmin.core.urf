...
if(_cea==0){
_cec.top=opts.hourDistance[0]+"px";
}else{
if(_cea<=12){
_cec.top=opts.hourDistance[1]+"px";
}
}
}
...
_ce9-=opts.hourDistance[1]-opts.hourDistance[0];
}
for(var i=0;i<data.length;i++){
var _cf0=data[i];
var cls="item f-column f-content-center";
...
return $.extend({},$.fn.combo.parseOptions(_cf9),$.parser.parseOptions(_cf9,[{hour24:"boolean"}]));
};
