...
namespace URF.Core.EF
{
  public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
  {
    ...
    public IQuery<TEntity> Query(IQueryObject<TEntity> queryObject) => new Query<TEntity>(this, queryObject);
    public IQuery<TEntity> Query(Expression<Func<TEntity, bool>> query) => new Query<TEntity>(this, query);
